...
venue: "Meyrin site, CERN"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "June 17-22, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
{% if online == "false" %}
  ...
  accessible to everybody. Please do not hesitate to contact the organizers (using contact details below)
  if you need wheelchair / scooter accessible rooms and restrooms during the school week.
</p>
<p>
